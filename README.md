...
Generate complete truth tables for any propositional logic expression
with up to 5 variables.
...
Validates logical arguments by checking if conclusions necessarily
...
-   Identifies counterexamples where premises are true but conclusion is
    false
-   Declares arguments as VALID or INVALID with clear explanation

### 3. Equivalence Checker

Compares two logical expressions to determine if they're logically
equivalent.
